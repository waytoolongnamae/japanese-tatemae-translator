...
The "Kyoto-style" 建前 (tatemae) expressions generated by this tool represent an **exaggerated, sarcastic interpretation** of high-context communication. While based on real cultural concepts, the tool intentionally amplifies passive-aggressive and indirect communication styles for **educational and entertainment purposes**.

**I do not endorse or recommend using this communication style in real professional or personal interactions.** Direct, honest, and respectful communication is always preferable. This tool is meant to:

- **Educate** about cultural communication differences and high-context vs. low-context cultures
- **Entertain** through linguistic creativity and cultural satire
- **Demonstrate** NLP and prompt engineering techniques
- **Explore** the concept of linguistic indirection as an academic subject

Use this tool responsibly and with cultural sensitivity. The generated translations should not be taken as authentic recommendations for real-world communication.
...
### Quick Access
- **[docs/QUICKSTART.md](docs/QUICKSTART.md)** - Quick start guide (CLI & Web)
- **[QUICKSTART_WEB.md](QUICKSTART_WEB.md)** - Web app quick start
- **[web/README.md](web/README.md)** - Web app documentation
- **[web/DEPLOYMENT.md](web/DEPLOYMENT.md)** - Deployment guide
- **[docs/KYOTO_STYLE.md](docs/KYOTO_STYLE.md)** - Kyoto-style communication guide
- **[docs/USAGE.md](docs/USAGE.md)** - Detailed CLI usage
